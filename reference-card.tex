...
%\definecolor{textcolor}{rgb}{0.85,0.85,0.85}
%\color{textcolor}
...
Plotten einer Regressionsgerade

\subsection*{Verteilungen}
\pythoninline{uniform.cdf(x=1, loc=0, scale=7)} \\
$P(X \leq 1)$ falls $X \sim Unif(0, 7)$ \\

\pythoninline{uniform.pdf(x=1, loc=0, scale=7)} \\
Dichte an der Stelle x = 3 falls $X \sim Unif(0, 7)$ \\

\pythoninline{uniform.rvs(size=3, loc=0, scale=7)} \\
