...
\mintinline{python}{series.index}: Zeilenbeschrift der Elemente von $series$ \\
\mintinline{python}{series.size}: Die Anzahl der Elemente von $series$ \\
\mintinline{python}{series[1]}: Zugriff auf ein Elemente via Index \\
\mintinline{python}{series["mi"]}: Zugriff via Zeilenbeschrift 
